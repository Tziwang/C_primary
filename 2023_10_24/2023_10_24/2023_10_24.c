...
//	//int data3[3] = { 1,2,3,4 };//err,4个元素超出规定了
//	
...
//	//char c;
//
//	int arr[4];//int [4]为数组的类型
//	char ch[5];//char [5]为数组的类型
//
//	return 0;
//}
...
//	char arr2[] = "####################";
//	int left = 0;
//	int right = strlen(arr1)-1; //strlen统计的是\0前面的数量
//
//	while (left<=right)
//	{
//		arr2[left] = arr1[left];
